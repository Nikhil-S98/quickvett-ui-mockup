...
function QuickVettV32({ siteVersion, onSiteVersionChange, onSignOut }) {
  ...
  return (
    <div className={`app-shell app-shell--v3 app-shell--v3-2 theme-${activeTheme} font-${globalFont}`}>
